...
![img](https://cdn.jsdelivr.net/gh/elihe2011/bedgraph@master/microservice/kafka_diagram.png)

## 3.1 Topic 主题

承载消息的逻辑容器，一般用来区分具体的业务，即同一类消息放在一个Topic中
...
- 一个Topic可分为多个Partition，每个Partition是一个有序队列，Partition中的每条消息都存在一个有序的偏移量(Offset)
...
![img](https://cdn.jsdelivr.net/gh/elihe2011/bedgraph@master/microservice/kafka_log_segment.png)
