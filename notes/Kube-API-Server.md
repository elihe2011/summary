...
kube-apiserver 提供了 Kubernetes 的 REST API，实现了认证、授权、准入控制等安全校验功能，同时也负责集群状态的存储操作。

![img](https://cdn.jsdelivr.net/gh/elihe2011/bedgraph@master/kubernetes/k8s-api-server.png) 
  ...
  "serverAddressByClientCIDRs": [
    {
      ...
      "serverAddress": "192.168.80.11:6443"
    }
  ]
}
```
